    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 p-4">
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to continue to StudyBud</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white py-4 rounded-2xl hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed font-bold text-lg mt-6"
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <Link href="/register" className="text-violet-600 hover:text-fuchsia-600 font-bold transition-colors">
              Sign up
            </Link>
          </p>
        </div>
